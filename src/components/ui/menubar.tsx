  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn("z-50 min-w-48 origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-2xl bg-popover p-1 text-popover-foreground shadow-2xl ring-1 ring-foreground/5", className )}
        {...props}
      />
    </MenubarPortal>
  )
...
function MenubarSubContent({
  ...
  return (
    <MenubarPrimitive.SubContent
      ...
      className={cn("z-50 min-w-32 origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-2xl bg-popover p-1 text-popover-foreground shadow-2xl ring-1 ring-foreground/5", className )}
      {...props}
    />
  )
}
